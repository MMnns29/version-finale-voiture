...
vitesse_kmh = 70 # [km/h] Vitesse en MRU.
vitesse_ms = vitesse_kmh / 3.6  # Modification de la vitesse en mètres par seconde.
...
# On applique omega aux 4 roues, à la bonne vitesse pour ne pas déraper.
mbs_data.Qq[11] = omega # Roue AV_G
mbs_data.Qq[16] = omega # Roue AV_D
mbs_data.Qq[26] = omega # Roue AR_G
mbs_data.Qq[30] = omega # Roue AR_D

# =========================================================
# 3. LA VRAIE DYNAMIQUE (Enregistrement sur 10s)
# =========================================================
print("\n>> LANCEMENT DU MRU (8 secondes)...")
# On relance de t=2.0 à t=8.0 avec la sauvegarde activée
mbs_dirdyn.set_options(dt0=1e-3, tf=8.0, save2file=1)
mbs_dirdyn.run()
...
"""
code avant de mettre tout en commmun
#!/usr/bin/env python3
import MBsysPy
import os
import numpy as np
