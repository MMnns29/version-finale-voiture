...
def user_JointForces(mbs_data, tsim):
    ...
    # Récupération des IDs des crémaillères
    jid_dir = mbs_data.joint_id["T2_barre_direction"]
    jid_dir_ar = mbs_data.joint_id["T2_barre_direction_AR"] # NOUVEAU : Crémaillère arrière
    ...
    # =========================================================
    # 1. APPLICATION DU CONTRÔLE DE DIRECTION (4WS)
    # =========================================================
    ...
    # Crémaillère Arrière (10% de l'angle, dans le même sens physique)
    # Le signe est négatif (-0.10) car l'attache de la biellette arrière est derrière l'essieu
    q_target_ar = -0.025 * q_target
